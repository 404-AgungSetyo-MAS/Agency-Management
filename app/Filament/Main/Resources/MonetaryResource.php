...
use App\Filament\Main\Resources\MonetaryResource\Pages;
use App\Filament\Main\Resources\MonetaryResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    Tables\Actions\ViewAction::make()->visible(fn (): bool => auth()->user()->isKeua()),
                    Tables\Actions\EditAction::make()->visible(fn (): bool => auth()->user()->isKeua()),
